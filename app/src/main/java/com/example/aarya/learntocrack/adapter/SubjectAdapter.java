package com.example.aarya.learntocrack.adapter;
...
public class SubjectAdapter extends RecyclerView.Adapter<SubjectAdapter.MyViewHolder> {
    ...
    public SubjectAdapter(Context mContext, List<Subject> topicsList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.count.setText(subject.getNumOfQuest() + " songs");
